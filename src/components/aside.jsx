        ...
        <animated.aside
            ...
            <header className="px-3 md:px-4 pb-2 md:pb-0 md:h-14 w-full flex flex-row justify-between bg-gray-200 mt-4">
                ...
                <div className="flex flex-row justify-between w-24">
                    <button title="Abmelden" onClick={signOut} className="h-9 w-9 rounded-full bg-gray-300 self-center flex flex-col justify-center items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                        </svg>
                    </button>
                    <Link href="/app/settings">
                        <a title="Einstellungen" className="h-9 w-9 rounded-full bg-gray-300 self-center flex flex-col justify-center items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
