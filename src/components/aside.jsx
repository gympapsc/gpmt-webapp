...
const Aside = ({ showMenu }) => {
    ...
    return (
        <animated.aside
            style={props}
            className={`${showMenu && isMobile ? "shadow-2xl md:shadow-none" : ""} z-30 absolute bottom-0 md:right-auto w-96 h-full overflow-x-hidden bg-gray-100 overflow-y-scroll border-r border-gray-300 `}>
