        ...
        <div className="p-4 grid grid-cols-2 gap-3">
            <Link href="/app">
                <a className="col-span-2 p-3 bg-white rounded-xl">
                    ...
                    <p className="text-gray-400">Hi, wie geht...</p>
                </a>
            </Link>
            <Link href="/app/micturition" id="micturition_widget">
                <a className="col-span-1 h-32 text-white rounded-xl bg-red-500 flex flex-col p-3">
                    <h3 className="text-md font-semibold">Miktion</h3>
                    <div className="mt-auto">
                        <h5 className="text-sm -mb-1 tracking-wide">18:30</h5>
            ...
            <Link href="/app/micturition">
                <a className="col-span-1 h-32 rounded-xl bg-white flex flex-col p-3">
                    ...
                    <div className="mt-auto">
                        <h4 className="text-2xl md:text-3xl font-bold tracking-wide">19:45</h4>
                    </div>
                </a>
            </Link>
            <Link href="/app/micturition">
                <a className="col-span-2 h-96 rounded-xl bg-white p-3">
