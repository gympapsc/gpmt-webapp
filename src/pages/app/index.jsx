...
const App = () => {
    ...
    const onClickUtter = e => {
        e.preventDefault()
        e.stopPropagation()
        utter()
    }

    const onClickSelectPhoto = e => {
        e.preventDefault()
        e.stopPropagation()
            ...
            <div className="flex flex-col w-full h-full">
                ...
                </Dialog>
                {
                    buttons.length ?
                        ...
                        :
                        <form className="sticky bottom-0 lg:w-2/3 flex flex-row mt-auto pt-3 w-full mx-auto">
                            ...
                            <input
                                ...
                                />
                            <button type="button" title="Fotoauswahl" aria-label="Fotoauswahl" onClick={onClickSelectPhoto} className="flex-grow-0 w-12 h-12 flex flex-col justify-center items-center text-white bg-indigo-800">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                            </button>
                            <button type="submit" title="Nachricht senden" aria-label="Nachricht senden" onClick={onClickUtter} className="flex-grow-0 w-12 h-12 flex flex-col justify-center items-center text-white bg-indigo-800">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
