                ...
                buttons.length ?
                    ...
                    <div className="sticky bottom-0 lg:w-2/3 flex flex-row mt-auto pt-3 w-full mx-auto">
                        ...
                        <input
                            ...
                            />
                        <button title="Fotoauswahl" ariaLabel="Fotoauswahl" onClick={e => fileInputRef.current.click()} className="flex-grow-0 w-12 h-12 flex flex-col justify-center items-center text-white bg-indigo-800">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <button title="Nachricht senden" ariaLabel="Nachricht senden" onClick={e => utter()} className="flex-grow-0 w-12 h-12 flex flex-col justify-center items-center text-white bg-indigo-800">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
